    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.header}>
          <Text style={styles.title}>{isForgotPassword ? "Reset Password" : "Seller Portal"}</Text>
          <Text style={styles.subtitle}>{isForgotPassword ? "Enter details to reset" : "Sign in to your account"}</Text>
        </View>
